...
silver_df = pd.read_csv('../../datasets/mendeley_enfermedades/silver/01_pca_40comp.csv')
...
df_reducido.to_csv('../../datasets/mendeley_enfermedades/silver/02_mutual_10comp.csv', index=False)