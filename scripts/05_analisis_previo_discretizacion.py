...
plt.savefig('../resultados/graficos/03_discretizacion_analisis.png', dpi=200, bbox_inches='tight')
...
with open('../resultados/informes/03_informe_discretizacion.txt', 'w', encoding='utf-8') as f:
    f.write(informe)