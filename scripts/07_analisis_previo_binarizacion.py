...
os.makedirs('../resultados/informes', exist_ok=True)

df_discretizado = pd.read_csv('../dataset/silver/03_discretizado_10comp.csv')
df_gold = pd.read_csv('../dataset/gold/kaggle_dataset.csv')
...
plt.savefig('../resultados/graficos/04_binarizacion_analisis.png', dpi=200, bbox_inches='tight')
...
with open('../resultados/informes/04_informe_binarizacion.txt', 'w', encoding='utf-8') as f:
    f.write(informe)