"""
Análisis de Binarización: Verificación simple
"""
...
df_discretizado = pd.read_csv('../../datasets/kaggle_enfermedades/silver/03_discretizado_10comp.csv')
df_gold = pd.read_csv('../../datasets/kaggle_enfermedades/gold/kaggle_dataset.csv')
...
plt.suptitle('Análisis de Binarización: 3 valores discretos → 2 bits binarios', 
             fontsize=14, fontweight='bold')
plt.tight_layout(rect=[0, 0, 1, 0.96])
plt.savefig('../../resultados/kaggle_enfermedades/graficos/04_binarizacion_analisis.png', dpi=200, bbox_inches='tight')
...
Shape final:      {df_gold.shape}

  1. PCA:              400 síntomas    → 100 componentes (70% varianza)
  2. Mutual Info:      100 componentes → 10 componentes (top MI)
  3. Discretización:   Valores continuos → 3 valores discretos (0,1,2)
  4. Binarización:     3 valores discretos → 20 bits binarios

RESULTADO: 400 features originales → 20 features binarias

"""

with open('../../resultados/kaggle_enfermedades/informes/04_informe_binarizacion.txt', 'w', encoding='utf-8') as f:
    f.write(informe)