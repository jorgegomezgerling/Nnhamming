...
plt.savefig('../../resultados/kaggle_enfermedades/graficos/01_pca_varianza_barras.png', dpi=200, bbox_inches='tight')
...
with open('../../resultados/kaggle_enfermedades/informes/01_informe_para_pca.txt', 'w') as f:
    f.write(informe)