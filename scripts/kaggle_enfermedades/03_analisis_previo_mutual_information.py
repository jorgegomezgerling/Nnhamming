...
silver_df = pd.read_csv('../../datasets/kaggle_enfermedades/silver/01_pca_100comp.csv')
...
plt.tight_layout()
plt.savefig('../../resultados/kaggle_enfermedades/graficos/02_mutual_information_analisis.png', dpi=200, bbox_inches='tight')
...
with open('../../resultados/kaggle_enfermedades/informes/02_informe_mutual_information.txt', 'w') as f:
    f.write(informe)